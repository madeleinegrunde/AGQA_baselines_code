...
def train(cfg):
    ...
    optimizer = optim.Adam(model.parameters(), cfg.train.lr, weight_decay=1e-3)
    ...
    for epoch in range(start_epoch, cfg.train.max_epochs):
        ...
        if cfg.val.flag:
            ...
            save_checkpoint(epoch, model, optimizer, model_kwargs_tosave, os.path.join(ckpt_dir, 'model-current.pt'))
...
def main():
    ...
    if cfg.dataset.name == 'tgif-qa': # TODO: PATH [change all paths below]
        cfg.dataset.train_question_pt = '/home/ubuntu/storage/questions/tgif-qa_frameqa_train_questions-%s.pt' % args.metric
        cfg.dataset.val_question_pt = '/home/ubuntu/storage/questions/tgif-qa_frameqa_val_questions-%s.pt' % args.metric
        cfg.dataset.vocab_json = '/home/ubuntu/storage/questions/tgif-qa_frameqa_vocab-%s.json' % args.metric
        cfg.dataset.appearance_feat = '/home/ubuntu/storage/video/appearance/tgif-qa_frameqa_appearance_feat.h5'
        cfg.dataset.motion_feat = '/home/ubuntu/storage/video/appearance/tgif-qa_frameqa_motion_feat.h5'
