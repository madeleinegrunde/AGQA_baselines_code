...
Dchar=64
Dword=300
dropout=0.15 # NEW DROPOUT: Original value 0.1
dropout_char = 0.01
...
class MultiHeadAttention(nn.Module):
    def __init__(self, n_head, d_model, d_k, d_v, dropout=0.1):
        ...
        # NEW DROPOUT: attn_dropout was originally unspecified
    ...
    def forward(self, q, k, v, attn_mask=None):
        ...
        # NEW DROPOUT: dropout only used to affect outputs (and not residual)
        return self.layer_norm(self.dropout(outputs+residual)), attns 
...
class PositionwiseFeedForward(nn.Module):
    ...
    def forward(self, x):
        ...
        output = self.dropout(output) # NEW DROPOUT
