...
def main(args):
    ...
    train_iter = train_dataset.batch_iter(args.num_epochs, args.batch_size, sample=False)
    ...
    if args.task=='Count':
            ...
            if iter % 100==0:
                ...
                with torch.no_grad():
                    ...
                    if args.test == 0:
                        ...
                        iter_val = 0
                        for batch_chunk in val_dataset.batch_iter(1, args.batch_size, shuffle=False, sample=True):
                            if iter_val % 10 == 0:
        ...
        print("in frameqa task!")
        best_val_acc = 0.0
        best_val_iter = 0.0

        with open('data/Vocabulary/index_to_ans_FrameQA.pkl', 'rb') as f_i2a:
            idx2ans = pickle.load(f_i2a)
    
        with open('data/Vocabulary/index_to_word_FrameQA.pkl', 'rb') as f_i2w:
                ...
                with torch.no_grad():
                    ...
                    if args.test==1:
                        ...
                        for batch_chunk in test_dataset.batch_iter(1, args.batch_size, shuffle=False, sample=False):
                            ...
                            # Format results
                            for q_id, q_token, a_idx, p_idx in zip(ids, question_words.cpu().numpy(), answers.cpu().numpy(), predictions.cpu().numpy()):
                                result = {}    
                        ...
                        print("Done creating, starting translating")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--metric', default='balanced', type=str)    
